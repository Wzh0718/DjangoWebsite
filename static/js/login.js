...
//密码校验
function validate() {
    const pwd = document.getElementById("passwd1").value;

    const checkpw = document.getElementById("passwd2").value;

    if (pwd === checkpw) {
        document.getElementById("bottom").disabled = false;
        document.getElementById("tishi").style.background = "#33CC00";
    } else {
